    ...
    def test_admin_login_opens_dashboard(self) -> None:
        ...
        outcome_cases = (
            ...
            (
                ...
                "Durum: Aynı kare, yeni doğrulama sayılmadı",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
                    ...
                    RecognitionState.DUPLICATE_SUPPRESSED,
                    duplicate=True,
                    suppression_reason="EXACT_COOLDOWN",
                ),
                "Durum: Tekrar kayıt engellendi (EXACT_COOLDOWN)",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
                    ...
                    RecognitionState.DUPLICATE_SUPPRESSED,
                    duplicate=True,
                    suppression_reason="SAME_DIRECTION_STATE",
                ),
                "Durum: Aynı yön kısa süreli tekrar koruması (SAME_DIRECTION_STATE)",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
                ...
                "Durum: Araç hâlâ aktif görünümde (ACTIVE_PRESENCE)",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
                    ...
                    suppression_reason="insufficient-temporal-evidence",
                    track_ended=True,
                ),
                "Durum: Kaydedilmedi: yetersiz ikinci kare",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
                    ...
                    save_attempted=True,
                    save_result="error",
                    persistence_exception_class="RuntimeError",
                ),
                "Durum: Kaydedilmedi: kayıt hatası (RuntimeError)",
                "OCR: 34 CLK 536",
            ),
            (
                RecognitionOutcome(
